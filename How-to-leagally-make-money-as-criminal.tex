...
\title{How to legally make money as criminal\\ A corruption how-to for Switzerland and Germany}
...
\begin{abstract}
This document describes the most common fraud schemes in Switzerland and Germany,
and how governments watch the show, orchestrated by them. By providing tons of
examples for fraudulent government officials, we proof that the Swiss state
is totally corrupt and driven by Cocaine business, operated in Credit Suisse.
Looking at Germany and THC prohibition, we analyse FDP Rösler's Weed business
model installed with Swiss authorities.
The document further outlines Swiss responsibility for world wide wars,
as their bad banks do not only drive international drug sales, but also
financing of current Russia war. All below ``Bankgeheimnis''.
It closes by showing how Chancellor Scholz tried to bury his CUMEX
participation to circumvent jail.
\end{abstract}
